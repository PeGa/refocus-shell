...
CHECKIN_INTERVAL="${REFOCUS_CHECKIN_INTERVAL:-60}"
...
export DB_PATH ENV_FILE NUDGE_INTERVAL CHECKIN_INTERVAL MAX_PROJECT_LENGTH DATE_FORMAT DATE_SHORT_FORMAT REPORT_LIMIT
